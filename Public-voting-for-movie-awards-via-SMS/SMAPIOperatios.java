...
public class SMAPIOperations
{
	...
	public String generateSignedLink(int formId, String destination) throws JSONException, UnirestException
	{

		String url = "http://api.gupshup.io/sm/api/smartmsg/msg/"+ formId +"/signedlink";
