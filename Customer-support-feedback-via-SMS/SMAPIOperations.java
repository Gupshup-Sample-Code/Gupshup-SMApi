...
public class SMAPIOperations
{
	...
	public String generateSignedLink(int chatletID, String destination) throws JSONException, UnirestException
	{

		String url = "http://api.gupshup.io/sm/api/smartmsg/msg/"+ chatletID +"/signedlink";
